//
//  CompletedTasksController.m
//  dropApp
//
//  Created by Mathieu Rolfo on 11/29/14.
...
@interface CompletedTasksController ()

@end

@implementation CompletedTasksController
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return [delegate.user.completedTasks count];
}
